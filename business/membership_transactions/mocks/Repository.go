...
func (_m *Repository) GetAll(status string, idUser uint, offset int, limit int) ([]membership_transactions.Domain, int64, error) {
	ret := _m.Called(status, idUser, offset, limit)

	var r0 []membership_transactions.Domain
	if rf, ok := ret.Get(0).(func(string, uint, int, int) []membership_transactions.Domain); ok {
...
func (_m *Repository) GetByID(idTrasaction uint) (membership_transactions.Domain, error) {
